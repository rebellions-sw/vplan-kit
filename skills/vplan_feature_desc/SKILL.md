...
|---|---|---|
| `command` | the command / opcode tables, the request-field (operand) lists and the response rules in the MAS | **its valid operand fields** — see below — plus what comes back and when it does not |
